...
const DestinationCard = ({style} : DestinationCardProps) => {
  return (
    <Link className={`font-raleway relative ${style} inline-block rounded-md group overflow-hidden`} href="/">
        <Image className="rounded-md group-hover:scale-125 transition-all duration-700 w-full h-full object-cover" src={Image1} alt="destination" />
