...
const HolidayOfferCard = () => {
  return (
    <Link className="relative group inline-block overflow-hidden h-[450px]" href={`/`}>
        ...
        <Image className="w-full h-full group-hover:rotate-6 object-cover group-hover:scale-150 transition-all duration-1000 brightness-50" src={HolidayOfferImage} alt="Holiday offer" />
