    ...
    <section className="bg-background pt-40 pb-20">
      <div className="w">
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <p>At Serendip Trails, we are committed to providing top-notch customer support to ensure every step of your journey is seamless and enjoyable. Whether you have a question, need assistance with a booking, or simply want to share your travel experiences, our dedicated team is here to help!
          </p>
        </div>
        ...
        <div className="p-16 bg-white shadow-lg rounded-md">
          <h4 className="font-raleway text-2xl font-bold text-secondary">Feel Free to contact with us</h4>
